...
#信息前置机
InformationfrontmachineIP='10.245.5.20'
InformationfrontmachineUser='root'
InformationfrontmachinePasswd='WindeyXT@2022'
#限速（M）
Speed='0.5'
###################################################################################
...
/Left=$SecondsData \
/Right=sftp://$InformationfrontmachineUser:$InformationfrontmachinePasswd@$InformationfrontmachineIP$SecondsData \
/L2R \
/BinComp=bcmNone \
/DontScanDest \
...
/DBLeftBasePath=$SecondsData \
/DBRightBasePath=sftp://$InformationfrontmachineUser:$InformationfrontmachinePasswd@$InformationfrontmachineIP$SecondsData
