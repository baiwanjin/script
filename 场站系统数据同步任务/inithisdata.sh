...
#检测文件
check(){
    filelist=('hisdatalogto.sh' 'lftp-4.4.8-11.ky3.kb2.x86_64.rpm' 'dos2unix-6.0.3-4.ky3.kb1.x86_64.rpm' 'syncrun')
...
init(){
    ...
    \cp `ls|grep -v rpm|grep -v inithisdata.sh` $CrontabList
